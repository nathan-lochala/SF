...
@section('content')
    ...
    <!--NEW FORM-->
    {!! Form::open(['id' => 'admin-form','url' => 'identification/visa_type']) !!}
    ...
    @if($visa_list->isEmpty())
        ...
        @else
            ...
            @foreach($visa_list as $visa)
                <tr>
                    <td>{{ $visa->type }}</td>
                    <td style="width: 50%">{{ $visa->description }}</td>
                    <td style="width: 15%">{{ $visa->chinese }}</td>
                    <td style="width: 10%"><a href="{{ url('identification/visa_type/' . $visa->id . '/edit') }}">
                    ...
                    <td style="width: 10%"><a href="{{ url('identification/visa_type/' . $visa->id . '/delete') }}">
                    @include('_buttons.click-button',[
                        'size' => 'xs',
                        'color' => 'danger',
                        'text' => 'Delete',
